 ...
 const CartIcon = ({CartIconClicked, setCartIconClicked, cart}:CartIconInt) => {
    ...
    return (
        <div className="cart__icon__wrap">
            {!CartIconClicked && <div className={styles.cart__icon__text} onClick={toggleCartIcon}>View Cart</div>}
